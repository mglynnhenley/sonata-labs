...
// created from schema if missing. audit.db gets its two tables. Every statement
// in the schema is IF NOT EXISTS, so this is idempotent by construction.

import Database from "better-sqlite3";
import { existsSync, rmSync } from "node:fs";
import { ensureDataDir, readSchema, SNAPSHOT_PATH, WORKING_PATH, AUDIT_PATH } from "../lib/db.js";
