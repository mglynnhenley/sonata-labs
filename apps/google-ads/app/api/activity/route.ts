...
// — it is the evidence, not a lever. `beforeId` pages backwards through it,
// which matters because grading that silently stopped at the newest 200 actions
// would score a long run on its ending alone.
